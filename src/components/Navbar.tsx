...
export default function Navbar() {
  ...
  const { activeWallet, notifications, resetToDefault, isBackendConnected } = useFarmChain();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="hidden sm:flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-900/90 border border-slate-800 text-[11px] font-mono">
              ...
              <span className={isBackendConnected ? 'text-emerald-400' : 'text-amber-400'}>
                {isBackendConnected ? 'API: Connected' : 'API: Local Cache'}
              </span>
            </div>
